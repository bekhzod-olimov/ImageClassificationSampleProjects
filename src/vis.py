...
class Visualization:
    ...
    def visualization(self):  [self.vis(data if self.ds_nomi in ["facial_expression", "pokemon"] else data.dataset, save_name) for (save_name, data) in self.vis_datas.items()]
